...
import bannerImage from "../assets/PojaBanner1.avif";
        ...
        >
            ...
            <div className="relative container mx-auto px-6 text-white flex justify-end">
                <div className="max-w-md  ">
                    ...
                    Discover the sacred ritual that blesses every aspect of your life with the divine grace of the eight forms of Goddess Lakshmi.                    </h1>
                </div>
            </div>
        </div>
    );
